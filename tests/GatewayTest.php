...
class GatewayTest extends GatewayTestCase
{
    ...
    public function testAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\SimplePay\Message\CreditCardRequest', $request);
    ...
    public function testCompleteAuthorize()
    {
        ...
        $this->assertInstanceOf('\Omnipay\SimplePay\Message\TransactionReferenceRequest', $request);
    ...
    public function testUpdateCard()
    {
        ...
        $this->assertInstanceOf('\Omnipay\SimplePay\Message\CardReferenceRequest', $request);
